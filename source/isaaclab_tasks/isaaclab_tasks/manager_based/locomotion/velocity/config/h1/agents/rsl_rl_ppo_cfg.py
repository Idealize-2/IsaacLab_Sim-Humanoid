...
@configclass
class H1RewardCurriculumPPORunnerCfg(H1RoughPPORunnerCfg):
    """PPO runner for the h1 reward-weight curriculum environment.
    ...
    def __post_init__(self):
        ...
        self.experiment_name = "h1_reward_curriculum"


@configclass
class H1PushCurriculumPPORunnerCfg(H1RoughPPORunnerCfg):
    """PPO runner for the h1 adaptive push-force curriculum environment.
    ...
    def __post_init__(self):
        super().__post_init__()
        self.max_iterations = 4000
        self.experiment_name = "h1_push_curriculum"


@configclass
class H1VelocityCurriculumPPORunnerCfg(H1RoughPPORunnerCfg):
    """PPO runner for the h1 progressive velocity-command curriculum environment.
    ...
    def __post_init__(self):
        ...
        self.experiment_name = "h1_velocity_curriculum"


@configclass
class H1FullCurriculumPPORunnerCfg(H1RoughPPORunnerCfg):
    """PPO runner for the h1 full multi-stage curriculum environment.
    ...
    def __post_init__(self):
        ...
        self.experiment_name = "h1_full_curriculum"
