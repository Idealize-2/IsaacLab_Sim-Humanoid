...
@configclass
class UnitreeA1RewardCurriculumPPORunnerCfg(UnitreeA1RoughPPORunnerCfg):
    """PPO runner for the a1 reward-weight curriculum environment.
    ...
    def __post_init__(self):
        ...
        self.experiment_name = "unitree_a1_reward_curriculum"


@configclass
class UnitreeA1PushCurriculumPPORunnerCfg(UnitreeA1RoughPPORunnerCfg):
    """PPO runner for the a1 adaptive push-force curriculum environment.
    ...
    def __post_init__(self):
        super().__post_init__()
        self.max_iterations = 4000
        self.experiment_name = "unitree_a1_push_curriculum"


@configclass
class UnitreeA1VelocityCurriculumPPORunnerCfg(UnitreeA1RoughPPORunnerCfg):
    """PPO runner for the a1 progressive velocity-command curriculum environment.
    ...
    def __post_init__(self):
        ...
        self.experiment_name = "unitree_a1_velocity_curriculum"


@configclass
class UnitreeA1FullCurriculumPPORunnerCfg(UnitreeA1RoughPPORunnerCfg):
    """PPO runner for the a1 full multi-stage curriculum environment.
    ...
    def __post_init__(self):
        ...
        self.experiment_name = "unitree_a1_full_curriculum"
